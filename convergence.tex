...
This derivation ignores the problem that stress is not differentiable if
one or more distances are zero, and it also does not say anything about
convergence of the algorithm. In De Leeuw
(\citeproc{ref-deleeuw_C_77}{1977}) and De Leeuw and Heiser
...
\subsection{Coefficient Space}\label{coefficient-space-1}
